...
//         callback(null,'/factory-managment-backend/uploads');
//      },
...
exports.find = (req,res) =>{
    ...
    if(req.query.id){
        ...
        productStockDetails.findById(id)
        .then(data =>{
            if(!data){
...
exports.update = (req,res) => {
    ...
    productStockDetails.findByIdAndUpdate(id, req.body,{useFindAndModify:false})
    .then(data =>{
        if(!data){
...
exports.delete = (req,res) => {
    ...
    productStockDetails.findByIdAndDelete(id)
    .then(data=>{
        if(!data){
