var materialCost = require('../model/matirialCost.model');
...
exports.create = (req,res)=>{ 
    ...
    const matCost = new materialCost({ 
        matirialCode : req.body.matirialCode,
        matirialBillNo : req.body.matirialBillNo,
        date : req.body.date,
    ...
    matCost
        ...
        .catch(err =>{ 
            res.status(500).send({
                message : err.message || "Some error occurred while creating a create material cost operation"
            });
        });
...
exports.update = (req,res) => { 
    ...
    materialCost.findByIdAndUpdate(id, req.body,{useFindAndModify:false})
    .then(data =>{
        if(!data){
...
exports.delete = (req,res) => {
    ...
    materialCost.findByIdAndDelete(id)
    .then(data=>{
        if(!data){
