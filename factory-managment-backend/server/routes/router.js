...
route.post('/api/prevProRound-details/',contoller.previousProductionRoundDetails.create);
route.get('/api/prevProRound-details/',contoller.previousProductionRoundDetails.find);
