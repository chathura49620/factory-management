...
export class PreviousProductonRoundTable extends Component {
  ...
  render() {
    const {id, productCategory, quantity, completedQuantity, remaningQuantity,status } = this.state;
      ...
      <tbody>
        {this.props.prevproductionRound.map((i) => (
          ...
          >
            ...
            onClick={() => this.setState({ editModalShow: true, id: i._id, productCategory: i.productCategory, quantity: i.quantity, completedQuantity: i.completedQuantity,remainingQuantity:i.remainingQuantity })}
            >Edit</button> 
            <button 
            className="btn-sm"
