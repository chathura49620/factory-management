                        ...
                        <Row>
                            ...
                            <Form onSubmit={this.handleSubmit} >
                                    ...
                                    <Form.Group controlId="proId">
                                        <Form.Control type="text" name="id" required placeholder="id"  defaultValue={this.props.id}/>
                                    </Form.Group>
                                    ...
                                    <Form.Group controlId="status">
                                        ...
                                        <Form.Control type="text" name="status" required placeholder="Status"  defaultValue={this.props.status}/>
                                    </Form.Group>
