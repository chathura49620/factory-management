...
class AddOrderDetails extends Component  {
  constructor(props) {
    super(props);
  ...
  handleSubmit(event, props) {
    ...
    if(isValid){
      fetch('http://localhost:5000/api/order-details', {
        ...
        body: JSON.stringify({
          orderId: event.target.orId.value,
          buyerName: event.target.byName.value,
          email: event.target.email.value,
          productCategory: event.target.productCategory.value,
          quantity: event.target.quntity.value,
          paymentMethode: event.target.payMethode.value,  
          ...
          <div className="col" >
            ...
            <Form onSubmit={this.handleSubmit}  >
                                    ...
                                    <Form.Group controlId="orderId">
                                        ...
                                        <Form.Control style={{ border: "1px solid #050139" }}  type="text" name="orderId"  placeholder="Order Id"  />
                                    ...
                                    <Form.Group controlId="buyerName">
                                        <Form.Label style={{fontWeight:"bold"}}>Buyer Name</Form.Label>
                                        <Form.Control style={{ border: "1px solid #050139" }} type="text" name="buyerName"  placeholder="Buyer Name"  />
                                        <div style={{background:"#f8d7da"}}>{this.state.validationError}</div>
                                    </Form.Group>
                                    <Form.Group controlId="email">
                                        <Form.Label style={{fontWeight:"bold"}}>Estimated Days</Form.Label>
                                        <Form.Control style={{ border: "1px solid #050139" }} type="text" name="email"  placeholder="Email" />
                                        <div style={{background:"#f8d7da"}}>{this.state.validationError}</div>
                                    </Form.Group>
                                    ...
                                    <Form.Group controlId="paymentMethode">
                                        ...
                                        <Form.Control style={{ border: "1px solid #050139" }} type="text" name="paymentMethode"  placeholder="Estimated Days" />
                                        <div style={{background:"#f8d7da"}}>{this.state.validationError}</div>
                                    </Form.Group>
