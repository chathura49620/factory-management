          ...
          <div className="col" >
            ...
            <Form onSubmit={this.handleSubmit}  >
                                    ...
                                    <Form.Group controlId="estDays">
                                        <Form.Label style={{fontWeight:"bold"}}>Compeleted Quatity</Form.Label>
                                        <Form.Control style={{ border: "1px solid #050139" }} type="text" name="comquantity"  placeholder="Compeleted Quantity" />
                                        <div style={{background:"#f8d7da"}}>{this.state.validationError}</div>
                                    </Form.Group>
                                    <Form.Group controlId="estEmp">
                                        <Form.Label style={{fontWeight:"bold"}}>Remaining Quantity</Form.Label>
                                        <Form.Control style={{ border: "1px solid #050139" }} type="text" name="remquantity"  placeholder="Remaining Quantity"  />
                                        <div style={{background:"#f8d7da"}}>{this.state.validationError}</div>
                                    </Form.Group>
                                    <Form.Group>
